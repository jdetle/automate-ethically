...
<!-- DRAFT: rewrite — new copy task: retrain resource list. This is a
     starter list of other people's programs, not the "coordination layer"
     the Retrain pillar text promises — say that plainly on the page rather
     than let it read as more finished than it is. -->

## The honest version first

The Retrain pillar on the front page promises something we haven't built:
a coordination layer that helps someone learn the next field while they
still have the job that's going away. That doesn't exist yet. What follows
is a list of real programs other people already run, so a programmer
looking at this today isn't waiting on us to have an answer.

We haven't vetted these beyond reading what they say about themselves and
checking that the sites are real. If you've used one and something here is
wrong, tell us: [join@automate-ethically.com](mailto:join@automate-ethically.com?subject=Retrain%20page%20correction).
...
## Lateral moves that reuse what you already know
